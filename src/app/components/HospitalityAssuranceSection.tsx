    ...
    >
      <div className="max-w-[1060px] mx-auto px-5 sm:px-8">
        <div className="mb-12 md:mb-16">
          <p className="text-[10.5px] md:text-[11px] font-semibold tracking-[0.16em] uppercase text-[#a5c8c2] mb-2">
            {eyebrow}
          </p>
          <h2 className="font-serif text-[28px] sm:text-[34px] md:text-[38px] leading-[1.18] text-white font-normal mb-3">
            {heading}
          </h2>
          <p className="text-[12px] md:text-[12.5px] leading-[1.65] text-[#90b8b1] max-w-[540px]">
            {description}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
          {pillars.map((item) => (
            ...
            >
              ...
              <h3 className="font-serif text-[16px] sm:text-[17px] font-normal leading-snug text-white mb-2.5">
                {item.title}
              </h3>

              <p className="text-[11.5px] leading-[1.62] text-[#90b8b1]">
                {item.description}
              </p>
            </div>
          ))}
